...
ADASinit = [0x81, 0xF8, 0x04, 0xAE,
            ...
            0x85, 0xE0, 0x00, 0x0A,
            0x8A, 0X07, 0X80, 0X00]
testADASinit = [0x85, 0x00, 0x00, 0x0B,
                0x88, 0xF8, 0x00, 0x0D,
                0x8B, 0x00, 0x00, 0x08,
                0x8A, 0x07, 0x96, 0x10,
                0x81, 0xF8, 0x00, 0xAE,
...
def adas1000_setRegister(regAddress, regValue):
    ...
    CShigh()
def reset():
    adas1000_setRegister(0x01, 0x000001)
...
#    adas1000_setRegister(0x0A, 0x078000)
     adas1000_setRegister(0x05, 0x00000B)
     adas1000_setRegister(0x08, 0xF8000D)
     adas1000_setRegister(0x0B, 0x000008)
     adas1000_setRegister(0x0A, 0x079610)
     adas1000_setRegister(0x01, 0xF800AE)
...
def adas1000_check():
     ...
     print("TESTTONE\n")
     adas1000_readRegister(0x08)
     print("FILTCTL\n")
     adas1000_readRegister(0x0B)
     print("FRCMTL\n")
